...
def get_couplet_dataset(good_file,fout_name,length = 30):
	f_good = open(good_file,'r',encoding = 'utf-8')
	fp_out = open(fout_name,'w')
	lines = f_good.readlines()
	for line in lines:
...
if __name__ == '__main__':
	fin_name = './dataset/couplet_okay.txt'
	# fin_name = '../temp/s3.txt'
	fout_name= './dataset/couplet.txt'
	...
	get_couplet_dataset('./dataset/couplet_okay.txt',fout_name,length = 40)
